...
const brownie : MenuItem = {
  ...
  course: "dessert", //bug 1 : incorrect desert parameter
  price: 6.0,
  nutrition: {
    calories: 450,
...
console.log(describe(lunchCombo.items[0]));//bug 2 : describe function needs to take Menu Item but test runs on lunchcombo is a 
